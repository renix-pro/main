...
export function useUpload(options: UseUploadOptions = {}) {
   ...
   * 
   * When projectId is provided, the backend returns an uploadToken
   * that binds the object path to that project for ownership verification.
   */
  const requestUploadUrl = useCallback(
    ...
    [options.projectId, options.purpose]
  );
